...
from arangodb.core.db_operations import (
    create_document,
    create_relationship,
    ensure_collections_and_views,
    list_documents
)
from arangodb.core.search.semantic_search import create_fixed_embeddings_if_needed
...
def setup_test_data(db):
    ...
    ensure_collections_and_views(db)
    ...
    for doc_data in test_docs:
        ...
        result = create_document(db, doc_data, COLLECTION_NAME)
...
def test_search_with_config(db):
    ...
    create_fixed_embeddings_if_needed(db, [COLLECTION_NAME])
