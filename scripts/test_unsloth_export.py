...
from src.arangodb.qa_generation.generate_sample_data import generate_sample_data
from src.arangodb.qa_generation.exporter import QAExporter
from src.arangodb.qa_generation.models import QABatch
...
async def test_export_formats(
    ...
    print(f"  python -m src.arangodb.qa_generation.unsloth_cli verify {output_jsonl[0]}")
