...
# Replace 'arangodb' with your project name throughout this file
PROJECT_NAME = "arangodb"
PROJECT_DESCRIPTION = "arangodb - Intelligent automation for the Granger ecosystem"
