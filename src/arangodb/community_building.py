    ...
    def _initialize_collections(self):
        ...
        try:
            ...
            if not self.db.has_graph(self.graph_name):
                ...
                has_community_edges = any(
                    ed["edge_collection"] == self.community_edge_collection 
...
if __name__ == "__main__":
    ...
    try:
        ...
        db.create_graph(
            ...
            edge_definitions=[
                {
                    "collection": "test_relationships",
                    "from": ["test_entities"],
                    "to": ["test_entities"]
                },
                {
                    "collection": "test_community_edges",
        ...
        if has_communities and communities_created:
            ...
            try:
                db.document(community_to_delete)
